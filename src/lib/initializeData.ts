...
export function initializeSampleData() {
  ...
  const exportSites: Site[] = [
    {
      id: 'EX-101',
      type: 'export',
      name: 'Downtown Raleigh Tower Excavation',
      location: '300 Fayetteville St, Raleigh, NC 27601',
      ...
      contaminated: false,
      priceExpectation: 4,
      projectOwner: 'Downtown Raleigh Development LLC',
      status: 'pending',
    ...
    },
    {
      id: 'EX-102',
      type: 'export',
      name: 'RTP Lab Campus Grading',
      location: '1000 Park Dr, Research Triangle Park, NC 27709',
    ...
    },
    {
      id: 'EX-103',
      type: 'export',
      name: 'Cary Town Center Retail Site',
      ...
      contaminated: false,
      priceExpectation: 0,
      projectOwner: 'Cary Retail Partners',
      status: 'pending',
    ...
    },
    {
      id: 'EX-104',
      type: 'export',
      name: 'North Hills Office Complex',
      location: '4600 Six Forks Rd, Raleigh, NC 27609',
      coordinates: { lat: 35.8407, lng: -78.6430 },
      soilType: 'clay',
      volume: 4500,
      ...
      contaminated: false,
      priceExpectation: 5,
      projectOwner: 'North Hills Properties LLC',
      status: 'pending',
    ...
    },
    {
      id: 'EX-105',
      type: 'export',
      name: 'Durham Southpoint Development',
      location: '6910 Fayetteville Rd, Durham, NC 27713',
      coordinates: { lat: 35.9024, lng: -78.9382 },
      soilType: 'loam',
      volume: 7200,
      ...
      contaminated: false,
      priceExpectation: 3,
      projectOwner: 'Southpoint Ventures',
      status: 'pending',
      createdAt: new Date('2025-02-05').toISOString(),
    },
  ];
  ...
  const importSites: Site[] = [
    {
      ...
      location: '2000 Ten Ten Rd, Apex, NC 27539',
      coordinates: { lat: 35.7327, lng: -78.8503 },
      soilType: 'clay',
      volume: 4000,
      scheduleStart: '2025-02-18',
      ...
      contaminated: false,
      priceExpectation: 6,
      projectOwner: 'Apex Development Corp',
      status: 'pending',
      createdAt: new Date('2025-02-01').toISOString(),
    },
    {
      id: 'IM-202',
      type: 'import',
      name: 'Holly Springs Solar Farm',
      location: '300 Avent Ferry Rd, Holly Springs, NC 27540',
      coordinates: { lat: 35.6513, lng: -78.8334 },
      soilType: 'loam',
      volume: 7500,
      ...
      contaminated: false,
      priceExpectation: 3,
      projectOwner: 'NC Solar Energy LLC',
      status: 'pending',
      createdAt: new Date('2025-02-01').toISOString(),
    },
    {
      id: 'IM-203',
      type: 'import',
      name: 'Warehouse District Greenway',
      location: '500 W Martin St, Raleigh, NC 27603',
      coordinates: { lat: 35.7740, lng: -78.6462 },
      soilType: 'loam',
      volume: 1800,
      scheduleStart: '2025-02-22',
      ...
      contaminated: false,
      priceExpectation: 2,
      projectOwner: 'City of Raleigh Parks',
      status: 'pending',
      createdAt: new Date('2025-02-04').toISOString(),
    },
    {
      id: 'IM-204',
      type: 'import',
      name: 'Morrisville Tech Campus',
      location: '1200 Perimeter Park Dr, Morrisville, NC 27560',
      coordinates: { lat: 35.8235, lng: -78.8254 },
      soilType: 'clay',
      volume: 5200,
      ...
      contaminated: false,
      priceExpectation: 4,
      projectOwner: 'Morrisville Commerce Center',
      status: 'pending',
      createdAt: new Date('2025-02-03').toISOString(),
    },
    {
      id: 'IM-205',
      type: 'import',
      name: 'Wake Forest Development',
      location: '12500 Capital Blvd, Wake Forest, NC 27587',
      ...
      contaminated: false,
      priceExpectation: 7,
      projectOwner: 'Wake Forest Builders',
      status: 'pending',
      createdAt: new Date('2025-02-05').toISOString(),
    },
  ];
  ...
  const reports: GeotechReport[] = [
    ...
    {
      id: 'GT-005',
      name: 'Ballantyne - Unsuitable Organic Soil',
      siteId: 'IM-201',
      ...
      reuseRecommendations: [],
      riskFactors: [
        'Extremely high organic content - unsuitable for structural use',
        'Very low compaction - will not support loads',
        'High moisture content indicates poor drainage',
        'Material will decompose over time causing settlement',
      ],
      treatmentOptions: [
        'Not recommended for reuse in construction',
        'Consider disposal at approved facility',
        'May be suitable for composting or landscaping only',
      ],
      location: 'Ballantyne, Charlotte, NC',
      testDate: '2025-01-18',
      laboratory: 'Carolina Geotechnical',
      notes: 'OH Organic soil - High peat content. Unsuitable for any structural application.',
    },
    {
      id: 'GT-006',
      name: 'Industrial Site - Contaminated Soil',
      siteId: 'EX-102',
      uploadDate: new Date('2025-01-25').toISOString(),
      fileType: 'pdf',
      ...
      properties: {
        ...
        contaminants: ['Lead', 'Arsenic', 'Petroleum hydrocarbons'],
      },
      aiExtracted: true,
      reuseRecommendations: [],
      riskFactors: [
        'Multiple heavy metal contaminants detected above safe levels',
        'Petroleum hydrocarbons present - environmental hazard',
        'Requires hazardous waste disposal protocols',
        'Cannot be used for any beneficial reuse',
      ],
      treatmentOptions: [
        'Mandatory professional environmental remediation',
        'Requires licensed hazardous waste disposal',
        'Thermal treatment or soil washing may be required',
        'Do not transport without proper permits',
      ],
      location: 'Former Industrial Site, Charlotte, NC',
      testDate: '2025-01-23',
      laboratory: 'Environmental Testing Services',
      notes: 'Hazardous contamination. Lead: 450 ppm, Arsenic: 89 ppm. Requires EPA notification.',
    },
    {
      id: 'GT-007',
      name: 'Steele Creek - Unsuitable Clay',
      siteId: 'EX-105',
      uploadDate: new Date('2025-01-22').toISOString(),
      fileType: 'pdf',
      classification: 'unsuitable',
      suitabilityScore: 35,
      properties: {
      ...
      reuseRecommendations: [],
      riskFactors: [
        'Extremely high clay content - poor drainage',
        'High organic content reduces stability',
        'Very low compaction strength',
        'High shrink-swell potential',
      ],
      treatmentOptions: [
        'Stabilization with lime or cement may improve properties',
        'Deep removal recommended for structural areas',
        'May be suitable for landscaping after treatment',
      ],
      location: 'Steele Creek, Charlotte, NC',
      testDate: '2025-01-20',
      laboratory: 'Geotechnical Solutions Inc',
      notes: 'CH Fat clay - High plasticity. Unsuitable without significant treatment.',
    },
    {
      id: 'GT-008',
      name: 'Fort Mill - Contaminated Industrial Fill',
      siteId: 'IM-204',
      uploadDate: new Date('2025-01-28').toISOString(),
      fileType: 'pdf',
      classification: 'contaminated',
      suitabilityScore: 22,
      properties: {
      ...
      reuseRecommendations: [],
      riskFactors: [
        'PCB contamination detected - hazardous waste',
        'Multiple heavy metals above residential limits',
        'Cannot be used for any construction purpose',
        'Requires special disposal procedures',
      ],
      treatmentOptions: [
        'Hazardous waste disposal required',
        'Contact EPA for disposal guidance',
        'Thermal desorption may be treatment option',
      ],
      location: 'Fort Mill Industrial Area, SC',
      testDate: '2025-01-26',
      laboratory: 'Environmental Testing Services',
      notes: 'PCBs: 12 ppm. Classified as hazardous waste. Special handling required.',
    },
  ];
