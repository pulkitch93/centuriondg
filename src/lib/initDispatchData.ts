...
export function initializeDispatchData() {
  ...
  const tickets = [
    ...
    // Add more historical deliveries for better metrics
    {
      id: 'T-9011',
      scheduleId: 'DS-5001',
      driverId: 'driver-5',
      ...
      acceptedAt: new Date(now.getTime() - 7 * 24 * 60 * 60 * 1000 + 12 * 60 * 1000).toISOString(),
      startedAt: new Date(now.getTime() - 7 * 24 * 60 * 60 * 1000 + 30 * 60 * 1000).toISOString(),
      loadedAt: new Date(now.getTime() - 7 * 24 * 60 * 60 * 1000 + 75 * 60 * 1000).toISOString(),
      deliveredAt: new Date(now.getTime() - 7 * 24 * 60 * 60 * 1000 + 135 * 60 * 1000).toISOString(),
      loadPhotoUrl: 'uploaded',
      unloadPhotoUrl: 'uploaded',
      digitalSignature: 'signature-9011',
      actualVolume: 18,
      customerRating: 4.5,
      fuelUsed: 8.9,
      gpsTrack: [],
    ...
    },
    {
      ...
      acceptedAt: new Date(now.getTime() - 4 * 24 * 60 * 60 * 1000 + 18 * 60 * 1000).toISOString(),
      startedAt: new Date(now.getTime() - 4 * 24 * 60 * 60 * 1000 + 40 * 60 * 1000).toISOString(),
      loadedAt: new Date(now.getTime() - 4 * 24 * 60 * 60 * 1000 + 85 * 60 * 1000).toISOString(),
      deliveredAt: new Date(now.getTime() - 4 * 24 * 60 * 60 * 1000 + 145 * 60 * 1000).toISOString(),
      loadPhotoUrl: 'uploaded',
      unloadPhotoUrl: 'uploaded',
      customerRating: 4.2,
      fuelUsed: 7.5,
    ...
    },
    {
      ...
      acceptedAt: new Date(now.getTime() - 8 * 24 * 60 * 60 * 1000 + 15 * 60 * 1000).toISOString(),
      startedAt: new Date(now.getTime() - 8 * 24 * 60 * 60 * 1000 + 35 * 60 * 1000).toISOString(),
      loadedAt: new Date(now.getTime() - 8 * 24 * 60 * 60 * 1000 + 80 * 60 * 1000).toISOString(),
      deliveredAt: new Date(now.getTime() - 8 * 24 * 60 * 60 * 1000 + 140 * 60 * 1000).toISOString(),
      loadPhotoUrl: 'uploaded',
      unloadPhotoUrl: 'uploaded',
      digitalSignature: 'signature-9013',
      actualVolume: 20,
      customerRating: 4.7,
      fuelUsed: 10.5,
      gpsTrack: [],
    ...
    },
    {
      ...
      acceptedAt: new Date(now.getTime() - 9 * 24 * 60 * 60 * 1000 + 10 * 60 * 1000).toISOString(),
      startedAt: new Date(now.getTime() - 9 * 24 * 60 * 60 * 1000 + 25 * 60 * 1000).toISOString(),
      loadedAt: new Date(now.getTime() - 9 * 24 * 60 * 60 * 1000 + 70 * 60 * 1000).toISOString(),
      deliveredAt: new Date(now.getTime() - 9 * 24 * 60 * 60 * 1000 + 130 * 60 * 1000).toISOString(),
      loadPhotoUrl: 'uploaded',
      unloadPhotoUrl: 'uploaded',
      digitalSignature: 'signature-9014',
      actualVolume: 22,
      customerRating: 5,
      fuelUsed: 11.8,
      gpsTrack: [],
    ...
    },
    {
      ...
      acceptedAt: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000 + 14 * 60 * 1000).toISOString(),
      startedAt: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000 + 32 * 60 * 1000).toISOString(),
      loadedAt: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000 + 77 * 60 * 1000).toISOString(),
      deliveredAt: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000 + 137 * 60 * 1000).toISOString(),
      loadPhotoUrl: 'uploaded',
      unloadPhotoUrl: 'uploaded',
      digitalSignature: 'signature-9015',
      actualVolume: 18,
      customerRating: 4.9,
      fuelUsed: 9.3,
      gpsTrack: [],
